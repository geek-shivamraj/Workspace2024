...
public class CurrencyConversionController {
    ...
    @GetMapping("/docker-currency-conversion-feign/from/{from}/to/{to}/quantity/{quantity}")
    ...
    @GetMapping("/docker-currency-conversion/from/{from}/to/{to}/quantity/{quantity}")
    public CurrencyConversion calculateCurrencyConversion(
        ...
        ResponseEntity<CurrencyConversion> currencyConversionEntity = restTemplate
                        .getForEntity("http://localhost:8000/docker-currency-exchange/from/{from}/to/{to}",
